...
| Token | Light | Dark | Usage |
|---|---|---|---|
| `--ts-bg-frosted` | `rgba(255,255,255, 0.8)` | `rgba(26,25,23, 0.8)` | Frosted surface background |
...
| `--ts-color-skeleton-pulse` | `neutral-100` | `#2c2a27` | Pulse animation target color |
