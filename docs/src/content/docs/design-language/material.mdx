...
|---|---|---|---|
| `--ts-color-bg-surface` | `#ffffff` | `#1a1917` | Default page and component background |
| `--ts-color-bg-elevated` | `#ffffff` | `#23221f` | Cards, modals — visually lifted surfaces |
| `--ts-color-bg-subtle` | `#f7f6f4` | `#23221f` | Tinted sections, alternate rows, hover backgrounds |
...
```css
/* Primary button */
background-color: var(--ts-color-interactive-primary);   /* #e45c0e */

/* Neutral button */
background-color: var(--ts-color-neutral-800);           /* #38352f */
```
...
--ts-color-bg-disabled: #2c2a27;                      /* Dark */
```
...
| Token | Light | Dark | Usage |
|---|---|---|---|
| `--ts-color-border-default` | `neutral-300` | `#4d4a44` | Standard input and card borders |
| `--ts-color-border-subtle` | `neutral-200` | `#3a3733` | Dividers, card section separators |
| `--ts-color-border-strong` | `neutral-400` | `#7a7570` | High contrast borders, outline buttons |
