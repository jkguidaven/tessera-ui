...
| `--ts-grid-gutter` | `var(--ts-spacing-6)` (24px) | Gap between columns |
| `--ts-grid-margin` | `var(--ts-spacing-4)` (16px) | Outer margin of the grid container |
...
Grid values adapt automatically in density modes — compact density reduces the gutter to `spacing-4`, and spacious density increases it to `spacing-8`.
...
|---|---|---|---|
| `--ts-spacing-1` | 2px | 4px | 6px |
| `--ts-spacing-2` | 6px | 8px | 10px |
| `--ts-spacing-3` | 8px | 12px | 16px |
| `--ts-spacing-4` | 12px | 16px | 20px |
| `--ts-spacing-5` | 16px | 20px | 24px |
| `--ts-spacing-6` | 20px | 24px | 32px |
