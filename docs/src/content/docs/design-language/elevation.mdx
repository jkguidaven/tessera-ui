...
|---|---|---|
| `--ts-shadow-inset-sm` | `inset 0 1px 2px 0 rgba(0,0,0,0.06)` | `inset 0 1px 2px 0 rgba(0,0,0,0.2)` |
| `--ts-shadow-inset-md` | `inset 0 2px 4px 0 rgba(0,0,0,0.1)` | `inset 0 2px 4px 0 rgba(0,0,0,0.3)` |
...
|---|---|---|---|
| `--ts-color-bg-elevated-1` | `neutral-0` | `#24221e` | Lowest elevated surface (cards at rest) |
| `--ts-color-bg-elevated-2` | `neutral-0` | `#2a2720` | Mid-level elevated surface (hovered cards, popovers) |
| `--ts-color-bg-elevated-3` | `neutral-0` | `#302c23` | Highest elevated surface (modals, floating panels) |

In light mode, all three levels map to `neutral-0` (white) because shadows alone provide sufficient visual separation. In dark mode, each step adds a subtle warm primary tint, creating a natural "closer to the light source" effect.
